...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Projects</title>
    <!-- Favicon -->
				  ...
				  <?php
					...
					foreach($reversed as $dire) {
						...
						if ($count < $max_posts) {
							...
							$pName=str_replace('projects/', '',$pName);
							...
							echo '<article class="single-from-blog">';
								...
								if (file_exists($dire.'/post_preview')) {
									...
									echo '<a href="article?id='.$pName.'"><button class="button button-default" data-text="Read more"><span>Read more</span></button></a>';
								} else {
									echo $post;
									echo '<a href="article?id='.$pName.'"><button class="button button-default" data-text="Read more"><span>Read more</span></button></a>';
								}
					...
					<article class="single-from-blog">
						...
						<h2>No recent projects found on <?php require_once('php/config.php'); echo constant("Website_Name"); ?>.</h2>
						</div>
						<p>There are no recent projects.</p>
					</article>
