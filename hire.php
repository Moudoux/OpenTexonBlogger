...
<?php
	...
	if (isset($_POST['butSubmit'])){
		...
		if ($isSafe == true) {
			...
			sendamail('strumaticjoker2@gmail.com','Job request','Hello my name is '.$name."\n".'My email is '.$email."\n\n".$message);
...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Hire us</title>
    <!-- Favicon -->
				  ...
				  <br>
                    ...
                    <form class="comment-form" method="POST">
                      <div class="form-group">                
						...
						<div class="form-group">
                        <textarea name="message" required placeholder="What do you want us to do ?*" class="form-control"></textarea>
                      </div>					  
