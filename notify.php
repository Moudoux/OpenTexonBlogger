...
<?php
	...
	if (isset($_POST['submitBtn'])){
		...
		foreach($files as $file) {
			...
			$pName=str_replace('.token', '',$pName);
			
			sendamail($pName,$title,$message);
...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Notify subscribers</title>
    <!-- Favicon -->
            ...
            <div class="row">
              <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="blog-left blog-details">
				  ...
				  <br>
                    <h2>Notify subscribers on <?php require_once('php/config.php'); echo constant("Website_Name"); ?>.</h2>
                    <form class="comment-form" method="POST">
                      <div class="form-group">                
                        <input type="text" name="title" placeholder="Email title*" required class="form-control">
                      </div>		
					  <div class="form-group">
                        <textarea name="message" required placeholder="Message*" class="form-control"></textarea>
                      </div>
                      <button class="button button-default" data-text="Send" name="submitBtn" type="submit"><span>Send</span></button>
                    </form>
                  </div>
				 ...
				 <?php
				  ...
				  <br>
                    <h2>Access denied.</h2>
					<p>You are not permitted to send mails to subscribers.</p>
					</div>
