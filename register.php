...
<?php
	...
	if (isset($_POST['submitBtn'])){
		...
		$gmail = isset($_POST['email']) ? $_POST['email'] : '';
		
		$error = registerUser($username,$password1,$password2,$desc,$fullname,$gmail);
...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Register</title>
    <!-- Favicon -->
            ...
            <div class="row">
              <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="blog-left blog-details">
				  ...
				  <br>
                    <h2>Register on <?php require_once('php/config.php'); echo constant("Website_Name"); ?></h2>
                    <form class="comment-form" method="POST">
					  ...
					  <div class="form-group">
                        <textarea name="desc" required placeholder="A brief description of yourself" class="form-control"></textarea>
                      </div>
					  <p><a href="<?php echo 'login?url='.$_GET['url']; ?>">Already have an account ?</a> | <a href="terms">Terms & Conditions</a></p>
                      <button class="button button-default" data-text="Register" name="submitBtn" type="submit"><span>Register</span></button>
                    </form>
                  </div>
				 ...
				 <?php
					...
					<div class="blog-comment">
				  <br>
                    <h2>You cannot register on <?php require_once('php/config.php'); echo constant("Website_Name"); ?>.</h2>
					<p>The owner of this site has turned off the ability to register an account. Please contact the server admin <a href="<?php require_once('php/config.php'); echo 'mailto:'.constant("Website_Server_Admin"); ?>"><?php require_once('php/config.php'); echo constant("Website_Server_Admin"); ?></a> for any questions.</p>
					</div>
