...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Website information</title>
    <!-- Favicon -->
              ...
              <div class="col-lg-8 col-md-7 col-sm-12">
				...
				?>
					...
					<div class="blog-title">
						<h2>Site backend information:</h2>
					</div>
					...
					<?php 
						...
						echo '<p>Website url: '.constant("Website_Url");
						echo '<br>Website name: '.constant("Website_Name");
						echo '<br>Website copyright: '.constant("Website_Copyright");
						echo '<br>Lockdown mode: '.constant("Website_Lockdown");
						echo '<br>Exception ip addresses: '.constant("Excpetions_IP_Addresses");
						echo '<br>Blocked ip addresses: '.constant("Blocker_Blocked_IPS");
						echo '<br>Blocked countries: '.constant("Blocker_Blocked_Countries");
						echo '<br>Ips ignored in logs: '.constant("Excpetions_IP_Ignore_Log");
						echo '<br>Website server admin: '.constant("Website_Server_Admin");
						echo '<br>Website maintaince expected done: '.constant("Website_Maintaince");
						echo '<br>Users can post articles: '.constant("Website_Article_CanPost");
						echo '<br>Website language: '.constant("Website_Language");
						echo '<br>Backend version: '.constant("Website_Version");
						echo '<br>Backend build date: '.constant("Website_Build_Date").'</p>';
					...
					<p><a href="notify">Notify subscribers</a><br>
					<a href="info">View site backend info</a><br>
					<a href="log">View site ip log</a></p>
					
					<div class="blog-title">
						<h2>Credit:</h2>
					</div>
					
					<p>For a list of software that made the <a href="https://opentexon.com/blog">OpenTexon Blog Platform</a> possible go to the <a href="credit">Credit</a> page.
					<br>The <a href="https://opentexon.com/blog">OpenTexon Blog Platform</a> is made by <a href="https://opentexon.com/profile?id=deftware">Alexander Arvidsson Örnberg</a></p>
