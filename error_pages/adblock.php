...
<head>
	<title>You're using AdBlock</title>
...
<body>
	<div class="alert-container">
		<div class="alert-inner">
			<div class="alert-heading">Please turn off AdBlock</div>
			<div class="alert-subheading">Please turn off AdBlock to visit this site.</div>
		</div>
	</div>
