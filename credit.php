...
<html lang="en">
  <head>
    ...
    <title><?php require_once('php/config.php'); echo constant("Website_Name"); ?> - Credit</title>
    <!-- Favicon -->
              ...
              <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="blog-left blog-details">
				  ...
				  <div class="blog-title">
					<h2>Software that made the <a href="https://opentexon.com/blog">OpenTexon Blog Platform</a> possible:</h2>
				  </div>
				  
				  <p>Our web template is provided by <a href="http://www.markups.io/">markups.io</a><br>
				  Our text editor for articles is provided by <a href="http://ckeditor.com/">ckeditor</a></p>
